...
class WaveletsWrapper():
    def __init__(self):
        # print(pywt.wavelist(None))
        ...
        # 'db24', 'db25', 'db26', 'db27', 'db28', 'db29', 'db30', 'db31', 'db32', 'db33', 'db34',
        # 'db35', 'db36', 'db37', 'db38', 'dmey', 'fbsp', 
        ...
        # 'shan', 'sym2', 'sym3', 'sym4', 'sym5', 'sym6', 'sym7', 'sym8', 'sym9', 'sym10', 'sym11', 
